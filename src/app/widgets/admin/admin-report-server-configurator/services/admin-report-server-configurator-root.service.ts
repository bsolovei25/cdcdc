...
export class AdminReportServerConfiguratorRootService {
    ...
    public getTepmplate(id: number): Promise<IReportTemplate[]> {
        return this.http.get<IReportTemplate[]>(this.restUrl + "/api/report-filetemplate/" + id + "/templates").toPromise();
    }
    ...
    public getReportFileNameOptions(templateId: number): Promise<ICustomOptionsTemplate> {
        return this.http.get<ICustomOptionsTemplate>(this.restUrl + `/api/report-template/${templateId}/filename-options`).toPromise();
    }
