import {
    ...
    EventEmitter,
    ViewChild,
    ElementRef, OnChanges, HostListener
} from "@angular/core";
import * as d3Selection from 'd3-selection';
import * as d3 from 'd3';
import { IDatesInterval, WidgetService } from "@dashboard/services/widget.service";
import { CHART_DATA } from "@widgets/SOU/sou-streams/smart-trend/components/trends/mock";
...
export class TrendsComponent implements OnChanges, OnInit {
    ...
    @Input() set size(value: number) {
        this.deltaCf = TrendsComponent.STEP_CF * value;
    }
    ...
    public changeScale(isPlus: boolean): void {
        this.deltaCf += (+isPlus || -1) * TrendsComponent.STEP_CF;
    }
