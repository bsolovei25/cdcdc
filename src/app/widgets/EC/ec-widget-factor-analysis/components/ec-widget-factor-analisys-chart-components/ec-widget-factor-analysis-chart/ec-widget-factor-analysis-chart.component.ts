...
import {
    ...
    DATA_SOURCE_PLAN,
} from './ec-widget-factor-analysis-chart.mock';
...
@Component({
    selector: 'evj-ec-widget-factor-analysis-chart',
    templateUrl: './ec-widget-factor-analysis-chart.component.html',
    styleUrls: ['./ec-widget-factor-analysis-chart.component.scss'],
})
export class EcWidgetFactorAnalysisChartComponent implements OnInit, OnChanges {
