...
export class PerformanceProgressCircleComponent implements OnInit, OnChanges {
    ...
    public criticalType: typeof CriticalType = CriticalType;
    ...
    public config = {
        ...
        majorTicks: 0, /// CHANGE VALUE PIE GAUGE  (!!!! меняем значение в зависимости количества дней в месяце)
    ...
    render(container, newValue, data): void {
        ...
        this.pointId = arcs
            ...
            .attr('fill', (d, i) => {
                ...
                } else if (status === this.criticalType.Danger.toString()) {
