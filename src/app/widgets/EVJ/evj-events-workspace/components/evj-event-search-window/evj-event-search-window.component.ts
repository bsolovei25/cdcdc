...
@Component({
    ...
    templateUrl: './evj-event-search-window.component.html',
    styleUrls: ['./evj-event-search-window.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EvjEventSearchWindowComponent implements OnInit, OnChanges {
    ...
    ngOnInit(): void {
        this.searchTerm$.pipe(debounceTime(450), distinctUntilChanged()).subscribe((search) => {
            this.search(search);
        });
    }
