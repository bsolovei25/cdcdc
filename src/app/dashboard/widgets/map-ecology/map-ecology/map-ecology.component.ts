...
export class MapEcologyComponent implements AfterViewInit, OnInit {
  ...
  private wsConnect() {
    this.widgetService.getWidgetLiveDataFromWS(this.id, 'map-ecology')
      .subscribe((ref) => {
          if(this.datas == null){
