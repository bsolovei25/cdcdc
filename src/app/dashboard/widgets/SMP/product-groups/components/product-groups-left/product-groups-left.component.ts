...
export class ProductGroupsLeftComponent implements OnInit {
  ...
  private d3Circle(data, el): void {
      let imageActive =
          'assets/icons/widgets/product-group-planning/icons_circle/' + data.TypeImage + '_a.svg';
      let image =
          'assets/icons/widgets/product-group-planning/icons_circle/' + data.TypeImage + '.svg';
