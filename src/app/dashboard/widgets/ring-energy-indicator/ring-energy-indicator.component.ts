...
export class RingEnergyIndicatorComponent implements AfterViewInit {
  ...
  public d3Circle(data, el): void {
    ...
    this.pic = (data.isCritical) ? ('/assets/pic/RingEnergyIndicator/active' + data.iconId + '.svg') : ('/assets/pic/RingEnergyIndicator/notActive' + data.iconId + '.svg');
    ...
    let imageInCenter = canvas.append("image")
