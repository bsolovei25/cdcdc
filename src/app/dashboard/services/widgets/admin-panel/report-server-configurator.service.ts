...
import {
    ...
    IReportFile,
    IFolder,
    IPostSystemOptionsTemplate, ICustomOptionsTemplate
...
export class ReportServerConfiguratorService {
    ...
    public getReportFileNameOptions(templateId: number): Observable<ICustomOptionsTemplate> {
        return this.http.get<ICustomOptionsTemplate>(this.restUrl + `/api/report-template/${templateId}/filename-options`);
    }

    public postReportFileNameOptions(templateId: number, template: ICustomOptionsTemplate): Observable<void> {
        return this.http.post<void>(this.restUrl + `/api/report-template/${templateId}/filename-options`, template);
    }
