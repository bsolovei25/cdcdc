...
import { IScheduleShiftDay } from '../../../models/ADMIN/admin-shift-schedule.model';
...
export class CdMatBalanceService {
    ...
    isOpenEvent$: BehaviorSubject<IEventsWidgetNotification> = new BehaviorSubject<IEventsWidgetNotification>(null);
    ...
    async getEstablishedFactsArray(): Promise<IAllEstablishedFacts[]> {
        return this.http
            .get<IAllEstablishedFacts[]>(this.restUrl + `/api/notification-reference/establishedfacts`)
            .toPromise();
    }
}
