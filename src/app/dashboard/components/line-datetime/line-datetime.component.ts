...
export class LineDatetimeComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    // public searchDate(data, highlightBlock: ElementRef): void {
    ...
    //     const positionStartLine = (start - 1) / count + onePieLineStart;
    //
    //     // const width = pieLine * countLine + 1.2 - onePieLineEnd - onePieLineStart;
    //     const width = pieLine * countLine - onePieLineEnd - onePieLineStart;
    //
    //     this.renderer.removeStyle(highlightBlock.nativeElement, 'left');
    //     this.renderer.setStyle(highlightBlock.nativeElement, 'left', `${positionStartLine}%`);
    //     this.renderer.setStyle(highlightBlock.nativeElement, 'width', `${width}%`);
    // }
}
